...
int visibleNodes(Node *root)
{
    ...
    // this is calculating the HEIGHT OF THE TREE!
    /*Since the height of the tree is defined as the largest path from the root to a leaf,
    we can recursively compute the height of the left and right sub-trees*/
    ...
    {
        h_left = visibleNodes(root->left);
        h_right = visibleNodes(root->right);
